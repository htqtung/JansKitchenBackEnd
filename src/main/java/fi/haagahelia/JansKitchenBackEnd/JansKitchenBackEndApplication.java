package fi.haagahelia.JansKitchenBackEnd;
...
import fi.haagahelia.JansKitchenBackEnd.domain.*;

@SpringBootApplication
public class JansKitchenBackEndApplication {

	public static void main(String[] args) {
		SpringApplication.run(JansKitchenBackEndApplication.class, args);
	}
	
	@Bean
	public CommandLineRunner demo(UserRepository uRepo, RecipeRepository recipeRepo, IngredientRepository inRepo, MethodRepository meRepo) {
		return (args) -> {
			...
			uRepo.save(u6);
			User u7 = new User("Jan Le", "janle@mail.com");
			uRepo.save(u7);
			User u8 = new User("Tung Huynh", "tunghuynh@mail.com");
			uRepo.save(u8);
